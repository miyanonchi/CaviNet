...
window.onload = function() {
    ...
    xhr.open("GET", BASE_PATH+"getLang.cgi", false);
    xhr.send("");
...
function getFileInfo(selectNum) {
    ...
    xhr.open("GET", BASE_PATH+"getValue.cgi?tbl=Picture", false);
    xhr.send(null);
    var PictureTable = new CGIResponse(xhr.response).Response.split("\n");

    xhr.open("GET", BASE_PATH+"getValue.cgi?tbl=Text&LanguageID=" + index, false);
    xhr.send(null);
    var TextTable = new CGIResponse(xhr.response).Response.split("\n");

    xhr.open("GET", BASE_PATH+"getValue.cgi?tbl=TPage&LanguageID=" + index, false);
    xhr.send(null);
